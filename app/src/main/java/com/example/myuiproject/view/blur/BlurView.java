...
/**
 * 通过系统自带的 ScriptIntrinsicBlur 类实现高斯模糊，使用方式：
 *
 */
...
public class BlurView extends View {
    ...
    public BlurView(Context context, AttributeSet attrs) {
        ...
        mBlurRadius = a.getDimension(R.styleable.RealtimeBlurView_realtimeBlurRadius, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 35, context.getResources().getDisplayMetrics()));
